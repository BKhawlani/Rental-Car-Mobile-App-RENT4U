...
class Sedancar extends StatefulWidget {
  const Sedancar({super.key});

  @override
  State<Sedancar> createState() => _SedancarState();
}

class _SedancarState extends State<Sedancar> {
  ...
  void initState() {
    ...
    fetchCars().then((carList) {
      setState(() {
        cars = carList;
        sedanCars = cars.where((car) => car.category == "Sedan").toList();
        isloading = false;
        isfetched = true;
      });
    }).catchError((error) {
                          ...
                          MaterialButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      Cardetails(car: sedanCars, index: i)));
                            },
                            child: Container(
